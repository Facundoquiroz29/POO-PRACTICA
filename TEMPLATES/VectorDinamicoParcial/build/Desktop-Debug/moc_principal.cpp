...
static constexpr auto qt_meta_stringdata_ZN9PrincipalE = QtMocHelpers::stringData(
    "Principal"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9PrincipalE[] = {
...
Q_CONSTINIT const QMetaObject Principal::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9PrincipalE.offsetsAndSizes,
    qt_meta_data_ZN9PrincipalE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9PrincipalE_t,
        // Q_OBJECT / Q_GADGET
...
void *Principal::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9PrincipalE.stringdata0))
